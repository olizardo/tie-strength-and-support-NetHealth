...
\begin{enumerate}
  \item \textbf{Companionship} (\texttt{supphang}): ``\textit{Somebody you have hung out with when feeling like company}''
  \item \textbf{Advice} (\texttt{suppadv}): ``\textit{Somebody you went to for advice when dealing with a life problem}''
  \item \textbf{Comfort} (\texttt{suppcomf}): ``\textit{Somebody you counted on to comfort you when something bad happened}''
  \item \textbf{Financial Assistance} (\texttt{suppfin}): ``\textit{Somebody you have gone to when in financial need}''
\end{enumerate}
